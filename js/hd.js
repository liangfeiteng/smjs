...
window.onload=function(){
	...
	var scroll =document.getElementById("scroll");
	 ...
	 var oblong=document.createElement("div");
	 oblong.className="oblong";
	 scroll.appendChild(oblong);
	 for (var i = 0; i < ullis.length-1; i++) {
	 	var span=document.createElement("span");
	 	oblong.appendChild(span);
	 }
	 oblong.children[0].className="current";
	 var oblongs=oblong.children;
	 for (var i = 0; i < oblongs.length; i++) {
	 	oblongs[i].index=i;
	 	oblongs[i].onmouseover =function () {
	 		for (var j= 0; j< oblongs.length; j++) {
	 			oblongs[j].className="";
	 		}
	 ...
	 function autoplay () {
                    ...
                    if(square > oblongs.length -1)
              {
                  ...
                  oblongs[square].className="current";
	 }
