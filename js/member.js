 ...
 * @date    2016-11-27 13:08:28
 * @version $Id$
 */
window.onload = function() {
	var me_but = document.getElementById('me-but');
	var me_phone = document.getElementById('me-phone');
	var me_tr = document.getElementById('me-tr');
	var me_btn = document.getElementById('me-btn');
	var me_koling = document.getElementById('me-koling');
	var shangma = document.getElementById('shangma');
	var me_td = document.getElementById('me-td');
	var me_td1 = document.getElementById('me-td1');
	var patt = /^1[34578]\d{9}$/;
	var patt2 = /^[a-zA-Z0-9]{4}$/;
	me_btn.onclick = function() {
		me_tr.style.display = "none";
		if(patt.test(me_phone.value)) {
			clearInterval(timer);
			this.disabled = true;
			var count = 60;
			var that = this;
			...
			function sendmessage() {
				count--;
				if(count >= 0) {
					that.value = "还剩余" + count + "秒";
				}
				else {
					that.value = "重新发送验证码";
					that.style.textIndent = 0;
					that.disabled = false;
					clearInterval(timer);
					count = 60;
				}
			}
			me_but.onclick = function() {
				me_td.style.display = "none";
				me_td1.style.display = "none";
				if(patt2.test(me_koling.value) && shangma.checked && me_phone.value != "") {
					alert("登陆成功！请稍后...");
					me_btn.value = "获取验证码";
					clearInterval(timer);
				}
				else{
					me_td.style.display = "block";
					me_td1.style.display = "block";
				}
			}
		}
		else{
			me_tr.style.display = "block";
		}
